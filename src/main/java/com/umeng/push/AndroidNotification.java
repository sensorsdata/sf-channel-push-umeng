...
public abstract class AndroidNotification extends UmengNotification {
  ...
  protected static final Set<String> PAYLOAD_KEYS = new HashSet<>(Arrays.asList("display_type"));

  // Keys can be set in the body level
  protected static final Set<String> BODY_KEYS = new HashSet<>(Arrays.asList("ticker", "title", "text",
      "builder_id", "icon", "largeIcon", "img", "play_vibrate", "play_lights", "play_sound",
  ...
  public void setMiActivity(String miActivity) throws Exception {
    if (miActivity != null && miActivity.trim().length() > 0) {
