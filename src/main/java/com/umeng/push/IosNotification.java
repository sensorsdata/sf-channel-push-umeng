...
public abstract class IosNotification extends UmengNotification {
  ...
  private static final Set<String> APS_KEYS = new HashSet<>(Arrays.asList("alert", "badge", "sound",
      "content-available"));
  ...
  public void setAlert(String title, String content) throws Exception {
    JSONObject alertObject = new JSONObject();
    alertObject.put("title", title);
    alertObject.put("body", content);
    setPredefinedKeyValue("alert", alertObject);
  }
